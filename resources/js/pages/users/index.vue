...
const usuariosActivos = computed(
    () => users.value.filter((u) => u.state === 'active').length,
);
...
const remove = (user: Users): void => {
    if (!confirm(`¿Eliminar al usuario "${user.name} ${user.lastname}"?`))
        return;
            ...
            <div class="space-y-6 p-4">
                ...
                >
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Gestiona usuarios, rol y personal desde esta misma
                        vista.
                    </p>
                    <form
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr v-for="user in usuariosFiltrados" :key="user.id"
                                    ...
                                    <td class="px-5 py-3.5">
                                        <div
                                            class="flex items-center gap-2 opacity-70 transition-opacity group-hover:opacity-100">
    ...
    <Teleport to="body">
        <div v-if="showModal" class="fixed inset-0 z-[70] flex items-center justify-center p-4">
            ...
            <div class="relative z-10 flex max-h-[92vh] w-full max-w-4xl flex-col rounded-2xl bg-white shadow-2xl">
                        ...
                        <p class="mt-0.5 text-sm text-gray-400">
                            {{
                                isEditing
                                    ...
                                    : 'Completa los campos para crear un nuevo acceso al sistema'
                            }}
                        </p>
                    </div>
                ...
                <!-- Body -->
                <form @submit.prevent="submit" class="space-y-6 overflow-y-auto px-7 py-6">
